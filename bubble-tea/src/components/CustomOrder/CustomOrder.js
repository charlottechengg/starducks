    ...
    <>
      ...
      <Grid container component="main" sx={{ height: "100vh" }}>
            ...
            <Grid item md={1}>
              <IconButton onClick={() => favouriteOnclick()}>
                {favourite ? (
                  ...
                  <FavoriteBorderIcon sx={{ color: "#ff5252" }} />
                )}
              </IconButton>
            </Grid>
          </Grid>
          <Grid
            ...
            <Grid item md={3} sm={3} justifyContent="flex-end">
              <Typography
                fontSize={20}
                fontWeight="bold"
                color={size === "large" ? "#B2B2B2" : "#022b3a"}>
                Bubble Tea 1
              </Typography>
              <Typography
                fontSize={20}
            ...
            <Grid item md={3} sm={3} justifyContent="flex-end">
              <Typography
                fontSize={20}
                fontWeight="bold"
                color={size === "small" ? "#022b3a" : "#B2B2B2"}>
                Ingredient:
              </Typography>
              <Typography
                fontSize={20}
        ...
        <Grid
            ...
            <OutlinedInput
              ...
              startAdornment={
                <InputAdornment position="start">
                  <IconButton onClick={() => decreaseQuantity()} edge="start">
              ...
              endAdornment={
                <InputAdornment position="end">
                  <IconButton onClick={() => increaseQuantity()} edge="end">
          ...
          <Grid sx={{ marginTop: "3%" }}>
            <Button
              sx={{ color: "#BA94D1", borderColor: "#BA94D1" }}
              onClick={() => setShoppingItem(shoppingItem + quantity)}
              variant="outlined">
